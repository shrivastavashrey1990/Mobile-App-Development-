package com.example.mytwittersearches;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main);
	     ...
	     // queryTableRow = (TableRow) findViewById(R.id.QueryTableLayout);
	...
	// add a new tag button and corresponding edit button to the GUI
	   private void makeTagGUI(String tag, int index)
	   {
	      ...
	      Button newDeleteButton = 
	 	      ...
	 	      newDeleteButton.setOnClickListener(deleteTagsButtonListener);
	...
	// load selected search in a web browser
	 ...
	 // end class FavoriteTwitterSearches
	   ...
	   public OnClickListener deleteTagsButtonListener = new OnClickListener() 
	   {
	      @Override
	      public void onClick(View v) 
	      {
	          ...
	          String tag = deleteButton.getText().toString();
	          String query = savedSearches.getString(tag, null);
	          SharedPreferences.Editor preferencesEditor = 
	                  savedSearches.edit();
	               
	               preferencesEditor.remove(tag); // remove all tag/query pairs
	         ...
	         builder.setTitle(R.string.confirmtagdelete); // title bar string

	         // provide an OK button that simply dismisses the dialog
	         builder.setPositiveButton(R.string.Deletebutton,
	            new DialogInterface.OnClickListener()
	            {
				...
				public void onClick(DialogInterface dialog, int button) {
	             ...
	             // end anonymous inner class
     	         ...
     	         // set the message to display
     	         builder.setMessage(R.string.confirmdelmsg);
